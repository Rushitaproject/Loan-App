...
import com.borrow.money.cash.loan.loanguide.adapterMoney.bankMoney.BankSelectionMoneyAdapter

import com.borrow.money.cash.loan.loanguide.databinding.MoneySelectionBankBinding
import com.borrow.money.cash.loan.loanguide.model.BankType

class SelectionBankMoney_32 : AppCompatActivity() {
    private lateinit var mBinding: MoneySelectionBankBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = MoneySelectionBankBinding.inflate(LayoutInflater.from(this))
        setContentView(mBinding.root)

        mBinding.conToolbar.heading.text = "Select Bank"
        ...
        val loanTypeRV = BankSelectionMoneyAdapter(bankListing)

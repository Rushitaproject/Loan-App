...
import com.borrow.money.cash.loan.loanguide.activityMoney.panMoney.PenCardMoney_21
...
class PanMoneyAdapter(var kindListing: ArrayList<LoanKind>) :
    RecyclerView.Adapter<PanMoneyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.relativeLoanType.setOnClickListener {
            it.isEnabled = false
                        ...
                        it.isEnabled = true
                        val intent = Intent(context, PenCardMoney_21::class.java)
                        intent.putExtra("NineteenType", position)

...
import com.borrow.money.cash.loan.loanguide.activityMoney.bikeMoney.BikeLoanMoney_25
...
class BikeMoneyAdapter(var kindListing: ArrayList<LoanKind>) :
    RecyclerView.Adapter<BikeMoneyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.relativeLoanType.setOnClickListener {
            ...
            it.isEnabled = false
                        it.isEnabled = true
                        val intent = Intent(context, BikeLoanMoney_25::class.java)
                        intent.putExtra(" TwentyFourType", position)
